	...
	public void start(){
		...
		while(true){
			...
			case "3":
				...
				break;
			case "4": 
				/*int outMoney = Integer.parseInt(JOptionPane.showInputDialog("얼마를 출금하시겠습니까?"));
				System.out.println("DEBUG:Rest Money=" + account.getMoney());
				if(outMoney>account.getMoney()){
					JOptionPane.showMessageDialog(null, "출금할수 없습니다.");
				}else{
					account.withdraw(outMoney);
				}
				JOptionPane.showMessageDialog(null, account.toString());*/
				JOptionPane.showMessageDialog(null, account.withdraw(Integer.parseInt(JOptionPane.showInputDialog("얼마를 출금하시겠습니까?"))));
				break;
			case "5": break;
			case "6": break;
			}
